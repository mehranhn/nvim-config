...
vim.g.registers_normal_mode = 0           -- 1 by default, open the window in normal mode
vim.g.registers_paste_in_normal_mode = 1  -- 0 by default, automatically perform a paste action when selecting a register in normal mode
vim.g.registers_visual_mode = 0           -- 1 by default, open the window in visual mode
vim.g.registers_insert_mode = 0           -- 1 by default, open the window in insert mode
